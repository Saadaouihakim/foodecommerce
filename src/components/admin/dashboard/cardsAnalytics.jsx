...
import AreaUsersList from "./areaUsersLis";
        ...
        <div className="flex m-4 gap-2">
          <div className="flex-1 px-2 justify-center w-16 bg-gray-700 shadow rounded h-300px">
            <div className="">
              ...
              <p className="py-4 font-bold text-yellow-500">500,000 TND</p>
              <p className="text-green-300">+30.5%</p>
            </div>
          </div>
          <div className="flex-1 px-2 justify-center w-16 bg-gray-700 shadow rounded max-h-300px">
            <div className="">
              ...
              <p className="py-4 font-bold text-yellow-500">300,000 TND</p>
